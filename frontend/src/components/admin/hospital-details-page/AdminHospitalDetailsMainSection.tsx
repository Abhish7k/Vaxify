    ...
    >
      ...
      >
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-sm text-slate-400 mt-1 font-mono">ID: {hospital.id}</p>
        </div>
      </motion.div>
                  ...
                  >
                    ...
                    <div className="text-right">
                      <div className="flex items-baseline justify-end gap-1">
                        <span
                          className={`text font-medium ${v.stock > 0 ? "text-slate-900" : "text-rose-500"}`}
                        >
                          {v.stock || 0}
                        </span>
                        <span className="text-slate-400 font-medium">/ {v.capacity || 100}</span>
                      </div>
                    </div>
                  </div>
                ))
          ...
          <Card className="h-full">
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center gap-3 text-slate-700">
                <span className="font-semibold w-20 text-xs text-slate-400 uppercase">Name</span>
                <span className="text-sm">{staff.name}</span>
              </div>
              <div className="flex items-center gap-3 text-slate-700">
                <span className="font-semibold w-20 text-xs text-slate-400 uppercase">Email</span>
                <span className="text-sm">{staff.email}</span>
              </div>
              <div className="flex items-center gap-3 text-slate-700">
                <span className="font-semibold w-20 text-xs text-slate-400 uppercase">Contact</span>
